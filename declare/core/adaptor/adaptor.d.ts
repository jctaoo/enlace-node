...
import { GenericEndpointInput } from "../endpoint/endpoint_input";
import { AdaptorConfig } from "./adaptor_config";
export declare abstract class Adaptor {
    ...
    get isAssociatedWithServer(): boolean;
    /**
     ...
     */
    protected clientToInput: Map<Client, GenericEndpointInput>;
    /**
